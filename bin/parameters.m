...
PA.collar = 0.2; %collar around detected speech in seconds
...
%%%%% Tokenizer
PA.Tokenizer = 'matlab'; %Tokenizer engine. Options: 'spacy', 'matlab'
...
PA.Lon = 0.6; %on threshold: %0.6 pk, 0.5 steps, 0.6 peers. 0.5 for LENA
...
PA.Segmodel = 'ideas.ckpt'; %segmentation model. Options: ideas.ckpt, steps.ckpt, stiv.ckpt, steps2.yaml
PA.Classif = 'iv_ccec.mat'; %iv system file name. Options:  'iv_ccec.mat', 'iv_ccec_matlab.mat'
PA.ClassifGen = 'knn_pk.mat'; %classifier generic child vs teacher. Options:  'knn_ccec.mat', 'knn_pk.mat', 'knn_steps', 'knn_steps_mat' (with iv_ccec_matlab) Empty if no general classif needed
PA.ClassifFocC = 'knn_pk_focal_child.mat'; %classifier generic focal child. Options:  'knn_pk_focal_child.mat' Empty if no focal classif needed
PA.ClassifFocT = 'knn_pk_focal_teacher.mat'; %% classifier generic focal teacher. Options: 'knn_pk_focal_teacher.mat';
